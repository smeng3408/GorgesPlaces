...
class SavedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Log.d("REPOERRORS sharedpfrag", "${sharedPrefs.toString()}")

        val view = inflater.inflate(R.layout.fragment_saved, container, false)
        val savedRecycler: RecyclerView = view.findViewById(R.id.savedRecycler)
        savedRecycler.layoutManager = LinearLayoutManager(requireActivity())
        ...
        savedRecycler.adapter = CustomAdapter(Repository1.savedPlaces, requireActivity(), 1, intentLauncher, sharedPrefs)
